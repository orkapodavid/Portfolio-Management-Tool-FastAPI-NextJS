...
PNL_ENDPOINTS = [
    ("/api/pnl/changes", "trade_date"),
    ("/api/pnl/summary", "trade_date"),
    ("/api/pnl/currency", "trade_date"),
    ("/api/pnl/full", "trade_date"),
    ("/api/pnl/kpi", None),
]


@pytest.mark.parametrize("path,date_param", PNL_ENDPOINTS)
class TestPnlRoutes:
