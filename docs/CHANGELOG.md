...
session-by-session work and exact verification results, see the
[continuation log](../continuations.md). Per-defect history lives in
`git log`.

## 0.1.0 - Initial parity rebuild {id="0.1.0"}
