...
describe("notification routes", () => {
  it.each([
    ...
    [
      ...
      "/dashboard/compliance/beneficial-ownership",
    ],
    [
      "Portfolio Tools",
      "Pay to Hold",
      "/dashboard/portfolio-tools/pay-to-hold",
    ],
    [
      "Instruments",
      "Instrument Data",
      "/dashboard/instruments/instrument-data",
    ],
  ...
  it.each([
    ...
    [
      "Portfolio Tools",
      "PO Settlement",
      "/dashboard/portfolio-tools/po-settlement",
    ],
